...
CassieCoreSim = struct_CassieCoreSim
CassieCoreSim_alloc = _libraries['./libcassiemujoco.so'].CassieCoreSim_alloc
CassieCoreSim_alloc.restype = POINTER_T(struct_CassieCoreSim)
CassieCoreSim_alloc.argtypes = []
CassieCoreSim_copy = _libraries['./libcassiemujoco.so'].CassieCoreSim_copy
CassieCoreSim_copy.restype = None
CassieCoreSim_copy.argtypes = [POINTER_T(struct_CassieCoreSim), POINTER_T(struct_CassieCoreSim)]
CassieCoreSim_free = _libraries['./libcassiemujoco.so'].CassieCoreSim_free
CassieCoreSim_free.restype = None
CassieCoreSim_free.argtypes = [POINTER_T(struct_CassieCoreSim)]
CassieCoreSim_setup = _libraries['./libcassiemujoco.so'].CassieCoreSim_setup
CassieCoreSim_setup.restype = None
CassieCoreSim_setup.argtypes = [POINTER_T(struct_CassieCoreSim)]
...
CassieCoreSim_step = _libraries['./libcassiemujoco.so'].CassieCoreSim_step
CassieCoreSim_step.restype = None
CassieCoreSim_step.argtypes = [POINTER_T(struct_CassieCoreSim), POINTER_T(struct_c__SA_cassie_user_in_t), POINTER_T(struct_c__SA_cassie_out_t), POINTER_T(struct_c__SA_cassie_in_t)]
class struct_PdInput(ctypes.Structure):
    pass

PdInput = struct_PdInput
PdInput_alloc = _libraries['./libcassiemujoco.so'].PdInput_alloc
PdInput_alloc.restype = POINTER_T(struct_PdInput)
PdInput_alloc.argtypes = []
PdInput_copy = _libraries['./libcassiemujoco.so'].PdInput_copy
PdInput_copy.restype = None
PdInput_copy.argtypes = [POINTER_T(struct_PdInput), POINTER_T(struct_PdInput)]
PdInput_free = _libraries['./libcassiemujoco.so'].PdInput_free
PdInput_free.restype = None
PdInput_free.argtypes = [POINTER_T(struct_PdInput)]
PdInput_setup = _libraries['./libcassiemujoco.so'].PdInput_setup
PdInput_setup.restype = None
PdInput_setup.argtypes = [POINTER_T(struct_PdInput)]
class struct_c__SA_pd_in_t(ctypes.Structure):
    pass

PdInput_step = _libraries['./libcassiemujoco.so'].PdInput_step
PdInput_step.restype = None
PdInput_step.argtypes = [POINTER_T(struct_PdInput), POINTER_T(struct_c__SA_pd_in_t), POINTER_T(struct_c__SA_cassie_out_t), POINTER_T(struct_c__SA_cassie_user_in_t)]
class struct_StateOutput(ctypes.Structure):
    pass

StateOutput = struct_StateOutput
StateOutput_alloc = _libraries['./libcassiemujoco.so'].StateOutput_alloc
StateOutput_alloc.restype = POINTER_T(struct_StateOutput)
StateOutput_alloc.argtypes = []
StateOutput_copy = _libraries['./libcassiemujoco.so'].StateOutput_copy
StateOutput_copy.restype = None
StateOutput_copy.argtypes = [POINTER_T(struct_StateOutput), POINTER_T(struct_StateOutput)]
StateOutput_free = _libraries['./libcassiemujoco.so'].StateOutput_free
StateOutput_free.restype = None
StateOutput_free.argtypes = [POINTER_T(struct_StateOutput)]
StateOutput_setup = _libraries['./libcassiemujoco.so'].StateOutput_setup
StateOutput_setup.restype = None
StateOutput_setup.argtypes = [POINTER_T(struct_StateOutput)]
class struct_c__SA_state_out_t(ctypes.Structure):
    pass

StateOutput_step = _libraries['./libcassiemujoco.so'].StateOutput_step
StateOutput_step.restype = None
StateOutput_step.argtypes = [POINTER_T(struct_StateOutput), POINTER_T(struct_c__SA_cassie_out_t), POINTER_T(struct_c__SA_state_out_t)]
...
__all__ = \
    ['get_newest_packet', 'struct_c__SA_state_radio_out_t',
    'cassie_sim_release', 'battery_out_t',
    'struct_c__SA_cassie_out_t', 'CassieCoreSim_free',
    'struct_c__SA_elmo_in_t', 'cassie_sim_check_self_collision',
    'struct_c__SA_cassie_leg_out_t', 'size_t', 'cassie_vis_t',
    'struct_StateOutput', 'struct_c__SA_cassie_in_t', 'udp_close',
    'DiagnosticCodes', 'StateOutput_step', 'cassie_vis_valid',
    'cassie_state_alloc', 'vectornav_out_t', 'StateOutput_free',
    'state_terrain_out_t', 'cassie_sim_copy', 'StateOutput_copy',
    'struct_c__SA_state_out_t', 'pack_cassie_user_in_t',
    'struct_c__SA_battery_out_t', 'pd_leg_in_t', 'wait_for_packet',
    'cassie_sim_free', 'cassie_cleanup',
    'struct_c__SA_cassie_user_in_t', 'cassie_vis_init',
    'struct_cassie_sim', 'struct_c__SA_cassie_pelvis_in_t',
    'CassieCoreSim_alloc', 'unpack_cassie_in_t', 'cassie_vis_close',
    'cassie_mujoco_init', 'struct_c__SA_pd_task_in_t',
    'cassie_leg_in_t', 'struct_c__SA_state_foot_out_t', 'socklen_t',
    'send_packet', 'StateOutput_alloc',
    'struct_c__SA_cassie_joint_out_t', 'pd_task_in_t',
    'cassie_sim_mjdata', 'cassie_sim_qpos', 'state_pelvis_out_t',
    'cassie_pelvis_in_t', 'cassie_pelvis_out_t', 'cassie_sim_radio',
    'cassie_sim_t', 'cassie_state_free', 'struct_c__SA_radio_out_t',
    'unpack_cassie_user_in_t', 'struct_PdInput',
    'struct_c__SA_pd_motor_in_t', 'struct_c__SA_elmo_out_t',
    'StateOutput', 'cassie_out_t', 'struct_c__SA_radio_in_t',
    'cassie_in_t', 'state_radio_out_t', 'pd_motor_in_t',
    'struct_c__SA_state_battery_out_t', 'pack_cassie_in_t',
    'cassie_sim_qvel', 'cassie_vis_free', 'cassie_get_state',
    'CassieCoreSim', 'CassieCoreSim_copy', 'unpack_cassie_out_t',
    'cassie_state_qvel', 'cassie_user_in_t',
    'struct_c__SA_cassie_leg_in_t', 'cassie_sim_apply_force',
    'cassie_sim_foot_forces', 'radio_in_t',
    'struct_c__SA_pd_leg_in_t', 'pack_cassie_out_t', 'PdInput',
    'udp_init_host', 'cassie_state_qpos', 'pack_state_out_t',
    'struct_cassie_state', 'PdInput_copy', 'state_joint_out_t',
    'PdInput_step', 'PdInput_setup', 'CassieCoreSim_setup',
    'cassie_sim_step_ethercat', 'unpack_pd_in_t', 'StateOutput_setup',
    'cassie_sim_check_obstacle_collision', 'struct_CassieCoreSim',
    'CassieCoreSim_step', 'struct_c__SA_state_joint_out_t',
    'cassie_set_state', 'state_out_t',
    'struct_c__SA_state_terrain_out_t', 'pack_pd_in_t',
    'cassie_sim_mjmodel', 'struct_c__SA_packet_header_info_t',
    'process_packet_header', 'struct_c__SA_vectornav_out_t',
    'unpack_state_out_t', 'cassie_sim_step_pd',
    'cassie_sim_clear_forces', 'cassie_sim_init', 'PdInput_alloc',
    'pd_in_t', 'cassie_sim_time', 'state_foot_out_t',
    'cassie_leg_out_t', 'cassie_state_time',
    'struct_c__SA_state_pelvis_out_t', 'struct_c__SA_pd_in_t',
    'cassie_sim_duplicate', 'udp_init_client', 'ssize_t',
    'cassie_state_copy', 'radio_out_t', 'elmo_in_t', 'PdInput_free',
    'struct_c__SA_target_pc_out_t', 'state_motor_out_t', 'elmo_out_t',
    'state_battery_out_t', 'cassie_state_t', 'packet_header_info_t',
    'cassie_sim_step', 'cassie_sim_hold',
    'struct_c__SA_state_motor_out_t', 'cassie_state_duplicate',
    'struct_c__SA_cassie_pelvis_out_t', 'struct_cassie_vis',
    'target_pc_out_t', 'cassie_vis_draw', 'struct_sockaddr',
    'cassie_joint_out_t']
